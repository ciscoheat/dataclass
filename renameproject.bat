@echo off
IF [%1] == [] GOTO noargs
fnr --cl --dir "%CD%" --find "%1" --replace "%2" --fileMask "*.*" --excludeFileMask "renameproject.bat"
fnr --cl --dir "%CD%\bin" --find "%1" --replace "%2" --fileMask "*.*" --excludeFileMask "renameproject.bat"
